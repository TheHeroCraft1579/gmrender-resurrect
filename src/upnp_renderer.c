...
static struct upnp_device_descriptor render_device = {
	.init_function          = upnp_renderer_init,
        ...
        .friendly_name          = "WebRadio UPNP",
        .manufacturer           = "Maximilian Dötsch",
        .manufacturer_url       = "https://github.com/TheHeroCraft1579/WebRadio",
        .model_description      = "WebRadio UPNP",
        .model_name             = "WebRadio UPNP",
        .model_number           = GM_COMPILE_VERSION,
        .model_url              = "https://github.com/TheHeroCraft1579/WebRadio",
        .serial_number          = "1",
